...
class ScoreRegistrationFloatingMenu(GameObject):
    ...
    def __init__(self, scene, rendering_layer):
        ...
        self.cant_do_his_sound = pygame.mixer.Sound("res/audio/annauncer/Cant do this 1.wav")
        ...
        text1 = "YOU HAVE MANAGED TO GET INTO THE TOP 4"
        ...
        self.save_button = Button("res/art/menu/save.png", "res/art/menu/save_active.png",
    ...
    def func_save_button(self):
        ...
        FileManager.write_new_row_in_csv_file("score_sheet.csv", [name, ScoreRegistrationFloatingMenu.TotalPoints])
