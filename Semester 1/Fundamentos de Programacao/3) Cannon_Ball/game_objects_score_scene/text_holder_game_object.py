...
class TextHolder(GameObject):
    def __init__(self, scene, rendering_layer):
        ...
        self.path_to_file = "score_sheet.csv"
        ...
        self.total_scores_for_exhibition = self.SHOW_AMOUNT if len(self.scores) >= self.SHOW_AMOUNT else len(self.scores)
        self.font_size = 22
        self.color = pygame.Color(255, 255, 255)
        self.initial_pos_y = -70
        self.spacing_y = 32
        self.spacing_x = 80
