...
from engine_JNeto_Productions.systems.inspector_canvas_system import InspectorDebuggingCanvas
...
class GameLoop:
    ...
    def __init__(self, native_resolution=RES_HD, window_resolution=RES_HD, scaled_resolution=RES_HD):

        pygame.init()

        GameScreen.init_screens(native_resolution, window_resolution, scaled_resolution)
    ...
    def run_game_loop(self):
        while True:
            ...
            """            
            # debugging inspector system, it needs to be on top of gizmos
            ...
            if self.show_inspector_debugging_canvas:
                self.inspector_debugging_canvas.render_inspector_text()
                #self.inspector_debugging_canvas.render_game_object_inspector_status(1, "white")  # GmObj info
            """
