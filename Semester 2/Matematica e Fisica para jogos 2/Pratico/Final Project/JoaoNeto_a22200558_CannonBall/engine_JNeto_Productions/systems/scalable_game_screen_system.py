...
class GameScreen:
    ...
    # DUMMY SCREEN (NATIVE RESOLUTION)
    ...
    @staticmethod
    def init_screens(dummy_screen_resolution: list[int], real_screen_resolution: list[int], up_scaling_target_resolution: list[int]):
    ...
    def get_inspector_status() -> str:
        return f"SCREEN SCALE SYSTEM\n" \
               ...
               f"res (scaled res):    {GameScreen.TargetResolutionForUpScaling[0]} x {GameScreen.TargetResolutionForUpScaling[1]}\n" \
